...
def page_cells_visualizer_body():
    ...
    if st.checkbox("Image Montage"): 
      ...
      labels = os.listdir('/workspaces/WalkthroughProject01/inputs/malaria_dataset/cell_images/validation')
      label_to_display = st.selectbox(label="Select label", options=labels, index=0)
      if st.button("Create Montage"):      
        image_montage(dir_path='/workspaces/WalkthroughProject01/inputs/malaria_dataset/cell_images/validation',
